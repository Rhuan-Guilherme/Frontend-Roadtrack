...
const SlideBar = () => {
  ...
  return (
    <nav
      className={`mt-2 md:mt-0 rounded-md md:rounded-none relative flex h-full bg-cinza-200 dark:bg-cinzaRoxo-800 transition-all duration-300 border-r md:border-cinza-300 dark:border-cinzaEscuro-500 ${
